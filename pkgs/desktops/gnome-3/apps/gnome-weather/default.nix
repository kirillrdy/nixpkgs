...
, libgweather, meson, ninja, geoclue2, gnome-desktop, python3, gsettings-desktop-schemas, libhandy}:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [
    ...
    libgweather gnome3.adwaita-icon-theme geoclue2 gsettings-desktop-schemas libhandy
  ];
